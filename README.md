...
🌱 Currently improving my skills in **Java, React.js, Node.js and Backend Development**

🤖 Exploring **AI, Multi-Agent Systems and intelligent applications**
...
![Multi Agent Systems](https://img.shields.io/badge/Multi--Agent_Systems-6A5ACD?style=for-the-badge)
...
### ⚖️ NyayaSetu — Digital Justice & Rehabilitation Platform

A civic-tech/legal-tech platform designed to improve:
...
An AI-oriented project exploring the use of **multiple intelligent agents** for coordinated rescue-system workflows.
...
A web-based project focused on providing useful information and insights through an interactive interface.
...
My continuously growing collection of **DSA solutions**, mainly implemented in Java.
